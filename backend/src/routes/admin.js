...
import { listModels, pickModel, generateWith, IMAGE_FORMATS, TEXT_FORMATS,
  guessFormat, deriveKey } from '../services/modelRegistry.js';
...
adminRouter.get('/models', requireSuper, asyncRoute(async (req, res) => {
 ...
 */
adminRouter.post('/models', requireSuper, asyncRoute(async (req, res) => {
  const b = req.body || {};
...
adminRouter.post('/models/:key/update', requireSuper, asyncRoute(async (req, res) => {
...
adminRouter.post('/models/:key/delete', requireSuper, asyncRoute(async (req, res) => {
  const key = String(req.params.key || '').toLowerCase();
 ...
 */
adminRouter.post('/models/:key/test', requireSuper, asyncRoute(async (req, res) => {
  const key = String(req.params.key || '').toLowerCase();
  const all = [
 ...
 */
adminRouter.post('/models/:key/default', requireSuper, asyncRoute(async (req, res) => {
  const key = String(req.params.key || '').toLowerCase();
  const enabled = [
 ...
 */
adminRouter.post('/models/remote-list', requireSuper, asyncRoute(async (req, res) => {
  const b = req.body || {};
