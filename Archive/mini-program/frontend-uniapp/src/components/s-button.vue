...
.s-btn--primary {
  background: $amber;
  color: $ink;
  box-shadow: inset 0 0 0 3rpx $amber-deep, 0 6rpx 0 $amber-line, 0 16rpx 36rpx rgba(138, 100, 16, 0.22);
}
...
.s-btn--mint {
  ...
  color: $white;
  box-shadow: 0 6rpx 0 $mint-shadow, 0 16rpx 36rpx rgba(46, 110, 73, 0.22);
}

.s-btn--plain {
  background: $paper-2;
  color: $ink-2;
  box-shadow: inset 0 0 0 2rpx $rule;
}
